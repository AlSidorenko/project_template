    ...
    <div class="collapse navbar-collapse ml-4">
        <ul class="navbar-nav">
            <li class="nav-item active">
                <a href="${pageContext.request.contextPath}/app/main"><img src="${pageContext.request.contextPath}\pic\bg\UCL-logo.png" width="30" border="0    "/></a>
            </li>
        </ul>
    </div>
    <div class="collapse navbar-collapse justify-content-end">
        <a href="${pageContext.request.contextPath}/app/login"><fmt:message key="log.in" bundle="${link}"/></a>
    </div>
    <ul>
